...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <!--Esta parte de nuestra web servirá para poder ponerte en contacto con nosotros de una manera muy sencilla. Introduciendo un email
            ...
            <asp:Table ID="Table1" runat="server" Width="548px">
                <asp:TableRow ID="TableRow1" runat="server">
                    <asp:TableCell ID="TableCell1" runat="server">
                        <asp:TextBox ID="TextBox1" runat="server" Width="50%" CssClass="box" placeholder="Tu Email"></asp:TextBox>
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow ID="TableRow2" runat="server">
                    <asp:TableCell ID="TableCell2" runat="server">
                        <asp:TextBox ID="TextBox2" runat="server" Width="100%" Height="150px" CssClass="box" placeholder="Escribe aquí tu consulta" TextMode="MultiLine"></asp:TextBox>
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow ID="TableRow3" runat="server">
                    <asp:TableCell ID="TableCell3" runat="server">
                        <asp:Button ID="Button2" runat="server" Text="Enviar" cssclass="boton"></asp:Button>
                    </asp:TableCell>   
                </asp:TableRow>
            </asp:Table>
