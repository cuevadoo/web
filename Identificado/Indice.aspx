                ...
                <asp:Table ID="Table3" runat="server" Width="100%">
                    ...
                    <asp:TableRow>
                        <asp:TableCell VerticalAlign="Top">
                            <asp:Table ID="TablePublicaciones" OnLoad="TablePublicaciones_Load" CssClass="tablaBuscador" runat="server" style="table-layout:fixed;text-wrap:normal;text-align:center;width:630px"></asp:Table>
                        </asp:TableCell>
                    </asp:TableRow>
                </asp:Table>
            </div>
